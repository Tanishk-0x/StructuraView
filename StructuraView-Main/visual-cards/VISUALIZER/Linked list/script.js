    ...
    async function setColor(item, oddrow, last_color) {
      if (oddrow == true) {
        if (item != 0 && new_row == true) {
          ...
          oldchild[1].style.backgroundColor = "Violet";
          oldchild[0].childNodes[0].style.backgroundColor = "Violet";
        } else if (item != 0 && first == false) {
          let oldchild = document.getElementById(`item${item - 1}`).children;
          oldchild[0].style.backgroundColor = "Violet";
          oldchild[1].childNodes[0].style.backgroundColor = "Violet";
        }
